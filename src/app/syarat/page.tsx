      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-8 space-y-6 text-sm text-gray-600 leading-relaxed">
          <section>
            ...
            <p>MyMenu adalah platform menu digital untuk UMKM. Dengan mendaftar, Anda setuju menggunakan layanan ini hanya untuk keperluan bisnis yang sah dan tidak melanggar hukum yang berlaku di Indonesia.</p>
          </section>
          <section>
