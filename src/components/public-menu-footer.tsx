...
export function PublicMenuFooter({ store, locations }: PublicMenuFooterProps) {
  ...
  const displayWhatsapp     = store.whatsapp
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-3">
              {displayAddress && (
                <a
                  ...
                  className={`flex items-start gap-2.5 text-sm ${descColor} transition-colors hover:underline`}
                  style={{ ['--hover-color' as any]: 'var(--color-primary)' }}
              ...
              {displayWhatsapp && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`flex items-center gap-2.5 text-sm ${descColor} transition-colors hover:underline`}
                  onMouseEnter={e => (e.currentTarget.style.color = 'var(--color-primary)')}
                  onMouseLeave={e => (e.currentTarget.style.color = '')}
                >
                  ...
                  <span>{formatWhatsAppNumber(displayWhatsapp)}</span>
                </a>
              )}
                  ...
                  <div className="flex items-center gap-2">
                    {instagram && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all hover:scale-105 ${isDark ? 'bg-slate-800 hover:bg-slate-700' : 'bg-slate-100 hover:bg-slate-200'}`}
                        aria-label="Instagram"
                      >
                        <svg className="w-4 h-4" style={{ color: 'var(--color-primary)' }} fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <a
              href="/"
              className="inline-flex items-center gap-2 text-sm font-semibold transition-all hover:gap-3 hover:opacity-80"
