  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-50 flex items-center gap-2.5 px-4 py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white text-sm font-semibold rounded-2xl transition-all active:scale-95 min-h-[44px]"
      >
