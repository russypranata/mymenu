...
export function SubscriptionBanner({
  ...
  // Don't render if subscription is valid and not expiring soon
  ...
  // Expired or no subscription — critical banner
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="space-y-2">
            ...
            {QRIS_IMAGE ? (
              ...
              /* Tidak ada QRIS maupun rekening — hubungi admin */
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-extrabold text-gray-900">{PAYMENT_AMOUNT}<span className="text-sm font-normal text-gray-400">/bulan</span></p>
                </div>
              </div>
              {BANK_ACCOUNT && (
